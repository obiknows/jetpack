    ...
    <div class="fl w-100 w-50-l pr2-l pl2-ns mb4 mb0-l mb4 outline">
      <div class="pa4">
        ...
        <p class="lh-copy mt2 mt3-m mt5-l f6">
          <span class="db-ns f6 fw7 lh-solid mb3 mb0-m mb4-l">Milly, my great mentor said:</span>
          <span class="fw9 f6 f1-l db lh-title mb3 mb4-l">“jetpack is for the kids.”</span>
          <span class="db-l measure-wide">
          Its really lit. Yadda yada yada. jetpack is the essence of syntax: the discipline
          that controls the proper use of grammar in the construction of phrases and the articulation of a language, Design.
        </span>
        </p>
      </div>
    </div>
